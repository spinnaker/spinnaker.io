...
See the docs on [Git-based-workflows](/docs/v1/guides/user/managed-delivery/git-based-workflows/) for detailed instructions.
...
For more help with this endpoint, see the the [API](/docs/v1/guides/user/managed-delivery/api/#validating-yaml) doc.
