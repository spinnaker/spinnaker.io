---
title:  "Artifacts In Pipelines (Legacy)"
...
{{< figure src="./expected-artifact-trigger.png" >}}

The UI provides short-hand for defining some types of
...
{{< figure src="./pubsub-trigger-artifact.png" >}}

A pubsub subscription configured to listen to changes in
...
{{< figure src="./configuration.svg" >}}

The pipeline declares that it expects an artifact matching _1_
