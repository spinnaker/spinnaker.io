...
> Please note that you should only proceed with this if you have [AWS EC2](/docs/setup/install/providers/aws/aws-ec2) configured as a cloud provider. These features requires version 1.24.
