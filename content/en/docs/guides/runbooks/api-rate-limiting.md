...
weight: 2
description: "If your Spinnaker deployment interacts with API clients, the API
rate limiter can help keep it reliable during traffic spikes and protect it from rogue clients."
---
