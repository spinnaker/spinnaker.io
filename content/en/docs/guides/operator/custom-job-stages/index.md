...
* `propertyFile` - The container name to [capture output data](/docs/guides/user/kubernetes/run-job-manifest#capturing-output) from. Captured output will be available in the pipeline context for use in downstream stages.
